      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative h-[500px] md:h-[600px] lg:h-[700px] rounded-lg overflow-hidden shadow-2xl"
          >
            <Image
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl title leading-tight">
                ...
                return (
                  ...
                  >
                    <div className="shrink-0">
                      <div className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-gray-900 transition-all duration-300 group-hover:bg-gray-900 group-hover:scale-110">
                        <Icon className="w-6 h-6 text-gray-900 group-hover:text-white transition-colors" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-lg md:text-xl title font-medium group-hover:text-gray-600 transition-colors">
                        {service.title}
                      </h3>
